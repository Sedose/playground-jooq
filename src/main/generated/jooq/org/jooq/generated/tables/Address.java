...
public class Address extends TableImpl<AddressRecord> {
     ...
     */
    public final TableField<AddressRecord, Integer> ADDRESS_ID = createField(DSL.name("address_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.address.person_id</code>.
     */
    public final TableField<AddressRecord, Integer> PERSON_ID = createField(DSL.name("person_id"), SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<AddressRecord, String> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR(100), this, "");
    ...
    public List<ForeignKey<AddressRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ADDRESS__FK_ADDRESS_PERSON);
    }
    ...
    public PersonPath person() {
        if (_person == null)
            _person = new PersonPath(this, Keys.ADDRESS__FK_ADDRESS_PERSON, null);
