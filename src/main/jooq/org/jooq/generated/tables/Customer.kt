...
import org.jooq.generated.keys.PK_CUSTOMER
...
open class Customer(
     ...
     */
    val FULL_NAME: TableField<CustomerRecord, String?> = createField(DSL.name("full_name"), SQLDataType.VARCHAR(255).nullable(false), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<CustomerRecord> = PK_CUSTOMER

    private lateinit var _customerOrder: CustomerOrderPath

    /**
     * Get the implicit to-many join path to the
     * <code>public.customer_order</code> table
     */
    fun customerOrder(): CustomerOrderPath {
        if (!this::_customerOrder.isInitialized)
            _customerOrder = CustomerOrderPath(this, null, CUSTOMER_ORDER__FK_CUSTOMER_ORDER_CUSTOMER_ID.inverseKey)

        return _customerOrder;
    }

    val customerOrder: CustomerOrderPath
        get(): CustomerOrderPath = customerOrder()
